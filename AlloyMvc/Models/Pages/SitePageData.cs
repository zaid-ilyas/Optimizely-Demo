...
namespace AlloyMvc.Models.Pages
{
    ...
    /// </summary>
    public abstract class SitePageData : PageData, ICustomCssInContentArea, ICustomUnifiedSearchContent
    {
        [Display(
        ...
        [Display(
            Name = "Site Page Content Area",
            GroupName = SystemTabNames.Content,
            Order = 400)]
        [CultureSpecific]
        public virtual ContentArea SitePageContentArea { get; set; }

        [Ignore]
        public virtual string SearchTitle => this.MetaTitle;
        [Ignore]
